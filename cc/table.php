...
<link href="table/table/dist/css/tabulator.min.css" rel="stylesheet">
<script type="text/javascript" src="table/table/dist/js/tabulator.min.js"></script>
...
<div class="w3-cell-row">
  ...
  <select class="w3-select w3-border" id="filter-field">
    ...
    <option value="CALL REGISTER TYPE">call_reg_type</option>
...
?>
    ...
    movableColumns:true,
 	...
 	columns:[ //Define Table Columns
            ...
            {title:"ENGINEER ID ASSIGNED", field:"eng_ass", sorter:"string"},
            {title:"ENGINEER NAME ASSIGNED", field:"eng_ass_name", sorter:"string"},
            {title:"SPARES USED", field:"spare_used", sorter:"string"},
            {title:"IS ENGINEER CLOSED CALL OR NOT(YES[0],NO[1])", field:"is_eng_closed", sorter:"string"},
