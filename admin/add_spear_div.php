...
$query = "INSERT INTO `devices` (device) VALUES ('$bname')";
...
echo '<div id="id01" class="w3-modal  w3-animate-zoom">
    <div class="w3-modal-content w3-padding-16 w3-card">
      <div class="w3-container"><p class="w3-panel w3-green w3-round" >DEVICE ADDED<p>
      <br/>
      
      <p><center> <a class="w3-btn w3-yellow w3-border" href="add_spear_div.php">DONE</a></center>
      </p>
      </div></div>
      </div>
      '; 
	...
	echo '<div id="id01" class="w3-modal  w3-animate-zoom">
    <div class="w3-modal-content w3-padding-16 w3-card">
      <div class="w3-container"><p class="w3-panel w3-green w3-round" >ERROR! CAN NOT ADD DEVICE<p>
      <p><center> <a class="w3-btn w3-yellow w3-border" href="add_spear_div.php">OK</a></center>
      </p>
      </div></div></div>'; 
	  echo'<script>document.getElementById("id01").style.display="block"</script>';
}	
...
<center><p class="w3-blue">ADD DEVICE</p></center>

<input type="hidden" name="new" value="1" />


<div class="w3-row">
<lable class="w3-half" >ENGINEER DEVICE NAME</lable> 
...
<center><input align="center"  value="ADD DEVICE" type="submit" class="w3-btn  w3-center w3-blue" name="" > </center>
...
<table id="id01" class="w3-table-all  w3-responsive  ">
						<tr><th colspan="11"><center>DEVICES</center></th></tr>
