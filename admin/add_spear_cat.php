...
$query = "INSERT INTO `spare_cat` (cat_name) VALUES ('$bname')";
...
echo '<div id="id01" class="w3-modal  w3-animate-zoom">
    <div class="w3-modal-content w3-padding-16 w3-card">
      <div class="w3-container"><p class="w3-panel w3-green w3-round" >CATGEORY ADDED<p>
      <br/>
      
      <p><center> <a class="w3-btn w3-yellow w3-border" href="add_spear_cat.php">DONE</a></center>
      </p>
      </div></div>
      </div>
      '; 
	...
	echo '<div id="id01" class="w3-modal  w3-animate-zoom">
    <div class="w3-modal-content w3-padding-16 w3-card">
      <div class="w3-container"><p class="w3-panel w3-green w3-round" >ERROR! CAN NOT ADD CATEGORY<p>
      <p><center> <a class="w3-btn w3-yellow w3-border" href="add_spear_cat.php">OK</a></center>
      </p>
      </div></div></div>'; 
	  echo'<script>document.getElementById("id01").style.display="block"</script>';
}	
...
<div class="w3-row">
<lable class="w3-half" >CATEGORY NAME</lable> 
...
<center><input align="center"  value="ADD CATEGORY" type="submit" class="w3-btn  w3-center w3-blue" name="" > </center>
