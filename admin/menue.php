...
<body class="" >
     <div class="w3-sidebar w3-bar-block w3-white w3-card w3-animate-left" style="display:none" id="mySidebar">
                             <button onclick="w3_close()" class="w3-bar-item w3-button w3-large">Close &times;</button>
                                       ...
                                       <a class="w3-bar-item w3-button" href="menue.php">MENUE</a>
...
<br/>
  ...
  <button class="w3-bar-item w3-button tablink w3-red" onclick="openCity(event,'London')">GENRAL</button>
     <button class="w3-bar-item w3-button tablink" onclick="openCity(event,'Paris')">REPORTS</button>
    <button class="w3-bar-item w3-button tablink" onclick="openCity(event,'spears')">SPARES </button>
...
<div id="London" class="w3-container w3-display-container city">
 ...
 <center> <div class="w3-panel w3-round w3-white"><p> GENRAL OPTIONS</p></div></center>
  <!--<center> <button class="w3-btn w3-yellow w3-border" onclick="addcall()">REGISTER CALL</button></center><br/>-->
 <center> <button class="w3-btn w3-yellow w3-border" onclick="window.location.href='ass_call_index.php'">ASSGN CALL</button></center><br/>
 <center> <button class="w3-btn w3-yellow w3-border" onclick="window.location.href='approve_spare_index.php'">ASSGN SPARE</button></center><br/>
  <center> <button class="w3-btn w3-yellow w3-border" onclick="window.location.href='add_engineer.php'">ADD OR REMOVE ENGINEER</button></center><br/>
  <center> <button class="w3-btn w3-yellow w3-border" onclick="window.location.href='add_cc_users.php'">ADD OR REMOVE CC USER</button></center><br/>
...
<div id="Paris" class="w3-container w3-display-container city" style="display:none">
 ...
 <center> <div class="w3-panel w3-round w3-white"><p> REPORTS</p></div></center>
  ...
  <center> <button class="w3-btn w3-yellow w3-border" onclick="window.location.href='spare_all.php'">SPARES REPORTS</button></center><br/>
  <center> <button class="w3-btn w3-yellow w3-border" onclick="window.location.href='spare_print.php'">SPARES STOCK REPORT</button></center><br/>
...
<div id="spears" class="w3-container w3-display-container city" style="display:none">
 <!-- <span onclick="this.parentElement.style.display='none'"
  class="w3-button w3-large w3-display-topright">&times;</span>-->
 <br/>
...
<fieldset style="border:16px solid white" class="w3-card-4 w3-round-xxlarge w3-border-pale-red ">

<legend class=" w3-center  ">
    <center> <button class="w3-btn w3-xxxlarge w3-round-xxlarge w3-blue w3-border" onclick="add_spare()">ADD SPARE</button></center><br/>
</legend>

  <center> <button class="w3-btn w3-pale-blue w3-border" onclick="window.location.href='add_spear_brand.php'">ADD SPARE BRAND</button></center><br/>
  <center> <button class="w3-btn w3-pale-blue w3-border" onclick="window.location.href='add_spear_cat.php'">ADD SPARE CATEGORY</button></center><br/>
  <center> <button class="w3-btn w3-pale-blue w3-border" onclick="window.location.href='add_spear_spec.php'">ADD SPARE SPECIFICATION</button></center><br/>
  <center> <button class="w3-btn w3-pale-blue w3-border" onclick="window.location.href='add_spear_div.php'">ADD SPARE DEVICES</button></center><br/>
...
<div id="add_spare" class="w3-modal  w3-animate-zoom">
    <div class="w3-modal-content w3-padding-16 w3-card">
      <div class="w3-container"><p class="w3-panel w3-green w3-round" >
     
     
      <form  action="add_spear.php" method="POST" >
      <!--<input type="hidden" name="new" value="1" />-->
<select class="w3-select w3-panel w3-border w3-responsive w3-card w3-pale-red w3-round-xxlarge"  name="spare_cat" required>
<?php
$query_bank='select * from spare_cat';
...
<br /><br />
<center>
<button type="submit" name="submit" onclick="asset_table()" class="w3-button w3-theme-d4">GO</button></center>
<br /><br />
</form>
...
<script>
// Get the modal
var modal = document.getElementById('add_spare');
...
<script>
    ...
    function add_spare(){
    document.getElementById("add_spare").style.display="block"
    }
